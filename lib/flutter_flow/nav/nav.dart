...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const SearchPageWidget() : const Auth2LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => SearchPageWidget(
            searchDocuments: params.getParam<ProductsRecord>(
              'searchDocuments',
              ParamType.Document,
              true,
            ),
        ...
        FFRoute(
          ...
          path: '/filtersPage',
          asyncParams: {
            'documents': getDocList(['products'], ProductsRecord.fromSnapshot),
          },
          builder: (context, params) => FiltersPageWidget(
            ...
            sortingMethod: params.getParam(
              'sortingMethod',
              ParamType.String,
            ),
            documents: params.getParam<ProductsRecord>(
              'documents',
              ParamType.Document,
              true,
            ),
        ...
        FFRoute(
          name: 'likes_Page',
          path: '/likesPage',
          builder: (context, params) => const LikesPageWidget(),
        ),
        FFRoute(
          name: 'report_Form',
          path: '/reportForm',
          builder: (context, params) => const ReportFormWidget(),
        ),
        FFRoute(
          name: 'home_Page',
          path: '/homePage',
        ...
        FFRoute(
          ...
          path: '/reviewForm',
          asyncParams: {
            'reviewDoc': getDoc(['reviewss'], ReviewssRecord.fromSnapshot),
          },
          builder: (context, params) => ReviewFormWidget(
        ...
        FFRoute(
          name: 'recycle_Form',
          path: '/recycleForm',
          builder: (context, params) => const RecycleFormWidget(),
        ),
        FFRoute(
          name: 'recycles_Page',
          path: '/recyclesPage',
          builder: (context, params) => const RecyclesPageWidget(),
        ),
        FFRoute(
          name: 'auth_2_SMSAuthentication',
          path: '/auth2SMSAuthentication',
          builder: (context, params) => const Auth2SMSAuthenticationWidget(),
        )
